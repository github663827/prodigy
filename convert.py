...
# 节点文件路径列表
node_files = [
    '/THL5/home/shyunie/new_data/zscore/cn8_ce0d1fb11ff766f27fe478449ace7e55d54e0aa0/final_metric.csv',
    '/THL5/home/shyunie/new_data/zscore/cn10_d65d8420209b5e11527a447cd0775c2b889d92b3/final_metric.csv',
    # 添加更多节点文件路径...
]
...
# 源文件目录
source_dir = 'ai4hpc_deployment/src/eclipse_small_prod_dataset'
...
for node_file in node_files:
    ...
    # 创建对应的节点目录
    node_dir = os.path.join(source_dir, node_name)
